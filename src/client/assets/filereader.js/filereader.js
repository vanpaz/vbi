    ...
    function extend(destination, source) {
        for (var property in source) {
            if (source[property] && source[property].constructor &&
                ...
                // arguments.callee(destination[property], source[property]); // Changed by Jos de Jong to allow usage in strict mode
...
// })(this, document);  // changed by Jos de Jong to allow bundling
})(window, document);